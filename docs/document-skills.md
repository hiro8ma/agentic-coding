---
title: "公式ドキュメント処理スキル（pdf / docx）— 設計例として読む"
date: "2026-07-29"
tags: [agent-skills, pdf, docx, progressive-disclosure, reportlab, pypdf, docx-js, ooxml]
---

# 公式ドキュメント処理スキル（pdf / docx）

anthropics/skills の公式スキルのうち、ドキュメント処理系（pdf / docx / xlsx / pptx の 4 種）を設計例として読む。
